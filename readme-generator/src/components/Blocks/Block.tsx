...
const Block: React.FC<IBlockProps> = ({title, subtitle, index, blocks, setBlocks, resetBlocks, children}) => {
    ...
    return (
        <div className="bg-primary w-full rounded-2xl px-[25px] py-[28px]">
            ...
            <div>
                <Button className={`hover:opacity-90 transition-transform duration-500 transform ${isExpanded && "rotate-180"}`} onClick={() => {
