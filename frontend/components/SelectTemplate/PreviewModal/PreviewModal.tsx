...
const PreviewModal: React.FC<{ folder: string; templateTitle: string; modalOpen: boolean; setModalOpen: any }> = ({
    ...
    return (
        <Dialog open={modalOpen} onOpenChange={setModalOpen} modal defaultOpen={modalOpen}>
            ...
            <DialogContent>
                ...
                {markdownTemplate.isSuccess && markdownTemplate.data && (
                    <PreviewModalContent markdownTemplate={markdownTemplate} setModalOpen={setModalOpen} folder={folder} templateTitle={templateTitle} />
                )}
            </DialogContent >
        </Dialog >
    )
